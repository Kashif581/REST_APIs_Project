...
// put request provides all of the data that we want to update in our back-end
...
// patch request provides only the data that we want to update in our back-end
